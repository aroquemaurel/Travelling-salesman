...
${OBJECTDIR}/src/path.o: src/path.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -I/development/cours/L2/algo3/TP/voyageurDeCommerce/lib -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/path.o src/path.c
...
${OBJECTDIR}/src/path_nomain.o: ${OBJECTDIR}/src/path.o src/path.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I/development/cours/L2/algo3/TP/voyageurDeCommerce/lib -std=c99 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/path_nomain.o src/path.c;\
	else  \
